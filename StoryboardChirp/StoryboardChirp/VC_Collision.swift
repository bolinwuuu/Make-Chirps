...
//        let lengthof_windowframe_km = Float(ratio) * Float(radius1) * 4
      ...
      //  let startingPositionOneX = Int(self.windowFrame.bounds.midX + CGFloat(self.x1))
       // let startingPositionOneY = Int(self.windowFrame.bounds.midY + CGFloat(self.y1))
       // let startingPositionTwoX = Int(self.windowFrame.bounds.midX + CGFloat(self.x2))
       // let startingPositionTwoY = Int(self.windowFrame.bounds.midY + CGFloat(self.y2))
        
        let lengthof_windowframe_km = Int(windowFrame.frame.width * scaleDown) / 1000
        let testVar1 = self.a[0] / self.scaleDown * self.mass2 / (self.mass1 + self.mass2)
    
       // if (lengthof_windowframe_km < startingPositionOneX) || (lengthof_windowframe_km < startingPositionOneY) || //(lengthof_windowframe_km < startingPositionTwoX) || (lengthof_windowframe_km < startingPositionTwoY) {
       //     let maximumLength = max(startingPositionOneX, startingPositionOneY, startingPositionTwoX, startingPositionTwoY)
       //     scaleDown = scaleDown * 1.3
            // windowFrame.frame.width = maximumLength + 150
        //}
        // added /1000
